"""Constants for BES cipher internals.

These values are considered implementation details. They are exposed as
immutable tuples to prevent accidental mutation at runtime.
"""
from __future__ import annotations

# Substitution box used by Block.apply_sbox
SBOX: tuple[int, ...] = (
...
# Round constants for KeyBlock schedule
ROUND_CONSTANTS: tuple[int, ...] = (
    0x9B, 0x40, 0xB7, 0x1E, 0x1B, 0x4E, 0x68, 0x9E, 0xBE, 0x42, 0x76, 0xC2, 0xDC, 0x30, 0x4B, 0x17,
)

__all__ = ["SBOX", "ROUND_CONSTANTS"]
